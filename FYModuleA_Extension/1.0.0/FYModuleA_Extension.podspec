...
Pod::Spec.new do |s|
  ...
  s.name         = "FYModuleA_Extension"
  s.version      = "1.0.0"
  s.summary      = "FYModuleA_Extension."
  ...
  s.source       = { :git => "https://github.com/cao903775389/FYModuleA.git", :tag => "Extension-"+s.version.to_s }
  ...
  s.source_files  = "FYModuleA/FYModuleA_Category/**/*.{h,m}"
